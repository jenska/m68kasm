...
func TestAssembleCoreInstructions(t *testing.T) {
	tests := []struct {
		...
		{"DBNEForward", "DBNE D1, target\nNOP\nNOP\ntarget:\n", []byte{0x56, 0xC9, 0x00, 0x06, 0x4E, 0x71, 0x4E, 0x71}},
