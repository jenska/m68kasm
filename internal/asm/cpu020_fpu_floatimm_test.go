...
func TestAssembleFPUFloatImmediate(t *testing.T) {
	tests := []struct {
		...
		{"SingleOneAndHalf", "FMOVE.S #1.5,FP0\n", []byte{0xF2, 0x3C, 0x44, 0x00, 0x3F, 0xC0, 0x00, 0x00}},
		{"DoubleOneAndHalf", "FMOVE.D #1.5,FP0\n", []byte{0xF2, 0x3C, 0x54, 0x00, 0x3F, 0xF8, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00}},
		...
		{"ExtendedOneAndHalf", "FMOVE.X #1.5,FP0\n", []byte{
			0xF2, 0x3C, 0x48, 0x00, 0x3F, 0xFF, 0x00, 0x00, 0xC0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		}},
		{"ExtendedNegativeOne", "FMOVE.X #-1.0,FP0\n", []byte{
			0xF2, 0x3C, 0x48, 0x00, 0xBF, 0xFF, 0x00, 0x00, 0x80, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		}},
		{"ExtendedZero", "FMOVE.X #0.0,FP0\n", []byte{
			0xF2, 0x3C, 0x48, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		}},
		{"ExtendedIntegerLiteralAutoPromoted", "FADD.X #5,FP0\n", []byte{
			0xF2, 0x3C, 0x48, 0x22, 0x40, 0x01, 0x00, 0x00, 0xA0, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
		}},
	}
