...
| `--mmu` | `PMOVE` (nearly every PMMU register), `PFLUSHA`, the `P`-condition branch/set/trap family |
...
variants, `PMOVE`'s numbered breakpoint registers, the FPU transcendental
set, and a few other narrow, deliberately deferred corners). The default
